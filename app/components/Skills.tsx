...
const skills: Skill[] = [
  ...
  { name: "Zustand",       icon: <MdOutlineStorage size={36} />, iconColor: "#5c4a1e", iconBg: "#f5f0e6", percent: 90, category: "Frontend" },
  { name: "Tailwind CSS",  icon: <SiTailwindcss size={33} />,    iconColor: "#06B6D4", iconBg: "#e0f9fb", percent: 90, category: "Frontend" },
  { name: "SCSS",          icon: <SiSass size={36} />,            iconColor: "#CC6699", iconBg: "#fbeef5", percent: 100, category: "Frontend" },
  { name: "Bootstrap",     icon: <SiBootstrap size={33} />,      iconColor: "#7952B3", iconBg: "#f0ebfb", percent: 95, category: "Frontend" },
  { name: "HTML5",         icon: <FaHtml5 size={36} />,          iconColor: "#E34F26", iconBg: "#fdeee9", percent: 98, category: "Frontend" },
  { name: "CSS3",          icon: <FaCss3Alt size={36} />,        iconColor: "#1572B6", iconBg: "#e6f2fb", percent: 97, category: "Frontend" },
  { name: "jQuery",        icon: <SiJquery size={33} />,         iconColor: "#0769AD", iconBg: "#e5f0fb", percent: 82, category: "Frontend" },
  { name: "WordPress",     icon: <FaWordpress size={36} />,       iconColor: "#21759B", iconBg: "#e5f3f9", percent: 60, category: "Frontend" },
  // Backend — runtime → framework → databases → infra
  { name: "Node.js",    icon: <FaNodeJs size={36} />,   iconColor: "#339933", iconBg: "#e8f8e8", percent: 90, category: "Backend" },
  { name: "Express.js", icon: <SiExpress size={33} />,  iconColor: "#000000", iconBg: "#ebebeb", percent: 96, category: "Backend" },
  { name: "MongoDB",    icon: <SiMongodb size={33} />,  iconColor: "#47A248", iconBg: "#eaf7ea", percent: 80, category: "Backend" },
  { name: "SQL",        icon: <SiMysql size={33} />,    iconColor: "#4479A1", iconBg: "#e6f0f8", percent: 60, category: "Backend" },
  { name: "Docker",     icon: <SiDocker size={33} />,   iconColor: "#2496ED", iconBg: "#e5f4fd", percent: 60, category: "Backend" },
  // API & Testing
  { name: "Postman", icon: <SiPostman size={33} />, iconColor: "#FF6C37", iconBg: "#fff0ea", percent: 80, category: "API & Testing" },
  ...
  { name: "Bitbucket", icon: <SiBitbucket size={33} />, iconColor: "#0052CC", iconBg: "#e5ecf9", percent: 95, category: "Version Control" },
  { name: "Jira",      icon: <SiJira size={33} />,      iconColor: "#0052CC", iconBg: "#e5ecf9", percent: 99, category: "Version Control" },
  { name: "Trello",    icon: <SiTrello size={33} />,    iconColor: "#0052CC", iconBg: "#e5ecf9", percent: 99, category: "Version Control" },
];
...
export default function Skills() {
  ...
  const completionTimers = useRef<gsap.core.Tween[]>([]);
  const hasAnimated = useRef(false);

  const animateCards = useCallback(() => {
    if (!gridRef.current) return;

    completionTimers.current.forEach((t) => t.kill());
    ...
    cards.forEach((card, i) => {
      gsap.to(card, {
        ...
        onComplete: () => {
          ...
          const timer = gsap.delayedCall(0.7, () => {
  ...
  useEffect(() => {
    if (hasAnimated.current) animateCards();
  ...
  return (
    <section className="skills-section section-pad sect-white" ref={sectionRef}>
